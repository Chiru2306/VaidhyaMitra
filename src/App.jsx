...
function App() {
  ...
  const handlePrint = () => {
    const content = printContentRef.current.innerHTML; // Get the content to print
  ...
  return (
    <div className="App">
      ...
      <input type="text" name="regn" id="regn" value={regn} placeholder="Ex: 5001" onChange={(e) => setRegn(e.target.value)} />
      <h2>Complaints</h2>
